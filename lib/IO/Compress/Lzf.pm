...
use IO::Compress::Adapter::Lzf  2.021 ;
#use Compress::Lzf ;
...
=head2 lzf $input => $output [, OPTS]

C<lzf> expects at least two parameters, C<$input> and C<$output>.
...
C<lzf> will assume that it is an I<input fileglob string>. The
...
C<lzf> will assume that it is an I<output fileglob string>. The
...
See L<IO::Compress::Lzf::FAQ|IO::Compress::Lzf::FAQ/"Apache::GZip Revisited">

    

=head1 SEE ALSO

L<Compress::Zlib>, L<IO::Compress::Gzip>, L<IO::Uncompress::Gunzip>, L<IO::Compress::Deflate>, L<IO::Uncompress::Inflate>, L<IO::Compress::RawDeflate>, L<IO::Uncompress::RawInflate>, L<IO::Compress::Bzip2>, L<IO::Uncompress::Bunzip2>, L<IO::Compress::Lzop>, L<IO::Uncompress::UnLzop>, L<IO::Uncompress::UnLzf>, L<IO::Uncompress::AnyInflate>, L<IO::Uncompress::AnyUncompress>
